...
public class MeusDados extends AppCompatActivity {
    ...
    private void buscarDados() {
        if (clienteID >= 1) {
            ...
            cliente.setClientePF(clientePFController.
                    getClientePFByFK(getApplicationContext(), clienteID));

            if (!cliente.isPessoaFisica())
                cliente.setClientePJ(clientePJController.
                        getClientePJByFK(getApplicationContext(),cliente.getClientePF().getId()));
